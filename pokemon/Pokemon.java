...
public class Pokemon implements Serializable {
    ...
    /**
     * Caminho para as sprites do Pokémon
     */
     ...
     */
    public Pokemon(String nome, List<Tipo> tipos, int nivel, Map<Stat, Integer> statsBase, List<Ataque> ataques, String spritesPath, Map<Stat, Integer> evs, Natureza naturezaDefinida) {
        this.nome = nome;
    ...
    public Pokemon(Pokemon p) {
        this(p.nome, p.tipos, p.nivel, p.statsBase, p.ataques, p.spritesPath, p.evs, p.natureza);
    }
